            ...
            <Link
              ...
              className={`flex flex-col items-center justify-center min-w-[44px] min-h-[44px] px-2 py-1 rounded-lg transition-colors ${
                active
                  ...
                  : "text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 active:text-indigo-500"
              }`}
            >
              <Icon size={22} className="shrink-0" />
              <span className="text-[10px] font-medium mt-0.5 leading-tight text-inherit">
                {label}
              </span>
            </Link>
          );
