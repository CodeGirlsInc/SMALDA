...
import { GovernmentIdProvider } from './government-id.provider';

describe('GovernmentIdProvider', () => {
  let provider: GovernmentIdProvider;

  beforeEach(() => {
    provider = new GovernmentIdProvider();
  });
